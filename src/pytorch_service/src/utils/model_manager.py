...
class ModelManager:
    ...
    def __init__(self):
        if "pytorch_service" in os.getcwd(): 
            self.base_output_path = "src/output"
        else:
            self.base_output_path = "pytorch_service/src/output"
            ...
            for model_name, train_run_path in train_runs:
                ...
                if greater_is_better:
                    ...
                    if best_model_info["best_metric"] is None or best_metric_run > best_model_info["best_metric"]:
                        ...
                        best_model_info["best_metric"] = round(best_metric_run, 4)
    ...
    def get_all_models(self):
        return os.listdir(self.training_output_path)
